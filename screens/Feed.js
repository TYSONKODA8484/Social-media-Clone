import { FlatList, ScrollView, StyleSheet, Text, TouchableOpacity, View ,Image, TextInput } from 'react-native'
  ...
  function renderFeedPost() {
    return (
        ...
        <View style={{
          ...
          />
            <View style={{ marginLeft: 12}}>
              <Text style={{...FONTS.body4, fontWeight: 'bold', }}>Ankita Sharma</Text>
              <Text style={{
                ...FONTS.body4,
      ...
      <View style={{
        ...
        <Text style={{...FONTS.body4, fontWeight: 'bold'}}>#So who am I</Text>
        <Text style={{
          ...FONTS.body4
        }}>In this world of virtual conncetions. It is important to remember the value of real, meaningfull relationships </Text>
      ...
      {/* Posts likes and comments */}
          <View style={{
            ...
            <View style={{ flexDirection: 'row'}}>
              <View>
                <Text style={{...FONTS.body4, fontWeight: 'bold'}}>Liked By 340</Text>
              </View>
              <View style={{
                flexDirection: 'row',
                alignItems: 'center',
